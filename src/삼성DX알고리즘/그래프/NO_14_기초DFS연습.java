...
public class NO_14_기초DFS연습 {
	...
	private final static NO_14_UserSolution usersolution = new NO_14_UserSolution();
	...
	public static void main(String[] args) throws Exception {
		...
		for (int tc = 1; tc <= TC; tc++) {
			...
			N = Integer.parseInt(st.nextToken());	//인물수
			Q = Integer.parseInt(st.nextToken());	//숫자
			seed = Long.parseLong(st.nextToken());	//자손
